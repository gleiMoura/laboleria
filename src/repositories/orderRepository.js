...
async function getAllOrders(queryStringText) {
    return db.query(`SELECT cl.id AS "clientId", cl.name AS "clientName", cl.address AS address, cl.phone AS phone, ca.id as "cakeId", ca.name AS "cakeName", ca.price AS price, ca.description AS description, ca.image AS image, f.name AS flavour, o."createAt" AS "createAt", o.quantity AS quantity, o."totalPrice" AS totalPrice, o.id AS "orderId"
    FROM orders o
